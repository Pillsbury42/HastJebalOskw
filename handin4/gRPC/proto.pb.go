...
func (x *HasTokenMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HasTokenMessage) ProtoMessage() {}

func (x *HasTokenMessage) ProtoReflect() protoreflect.Message {
	mi := &file_gRPC_proto_proto_msgTypes[0]
...
// Deprecated: Use HasTokenMessage.ProtoReflect.Descriptor instead.
func (*HasTokenMessage) Descriptor() ([]byte, []int) {
	return file_gRPC_proto_proto_rawDescGZIP(), []int{0}
}

func (x *HasTokenMessage) GetToken() bool {
	if x != nil {
		return x.Token
	}
	return false
...
var file_gRPC_proto_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x67, 0x52, 0x50, 0x43, 0x22, 0x27, 0x0a, 0x0f, 0x48, 0x61, 0x73, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x22, 0x0e, 0x0a, 0x0c, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x32, 0x3e, 0x0a, 0x05, 0x4d, 0x75, 0x74, 0x65, 0x78, 0x12, 0x35, 0x0a, 0x08, 0x48, 0x61,
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x15, 0x2e, 0x67, 0x52, 0x50, 0x43, 0x2e, 0x48, 0x61,
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x12, 0x2e,
	...
	0x34, 0x2f, 0x67, 0x52, 0x50, 0x43, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_gRPC_proto_proto_goTypes = []interface{}{
	(*HasTokenMessage)(nil), // 0: gRPC.HasTokenMessage
	(*EmptyMessage)(nil),    // 1: gRPC.EmptyMessage
}
var file_gRPC_proto_proto_depIdxs = []int32{
	0, // 0: gRPC.Mutex.HasToken:input_type -> gRPC.HasTokenMessage
	1, // 1: gRPC.Mutex.HasToken:output_type -> gRPC.EmptyMessage
